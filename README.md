...
Forked from [original](https://github.com/betterze/StyleSpace) to allow for more control with generating specific seeds (instead of within a consecutive range).
---
